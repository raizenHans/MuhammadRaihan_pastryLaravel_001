...
<head>
    ...
    <title>@yield('page_title', 'Sistem Manajemen') — Artorious Pastry Admin</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge-noir { background: var(--noir); color: var(--gold-light); }
    ...
    <div class="content-area">
        ...
        <div class="topbar">
            <div class="topbar-title">
                <i class="fa-solid fa-layer-group" style="color:var(--gold); font-size:0.9rem"></i>
                @yield('page_title', 'Sistem Manajemen')
            </div>
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <div style="font-size:0.85rem; font-weight:700; line-height:1.2;">{{ Auth::user()->name ?? 'User' }}</div>
                        <div style="font-size:0.72rem; color:var(--warm-gray); text-transform:uppercase; letter-spacing:0.08em;">{{ Auth::user()->role ?? '' }}</div>
                    </div>
                </div>
            </div>
        </div>
